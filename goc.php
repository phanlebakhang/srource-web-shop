...
<section class="banner">
    <div class="banner-img">
        <img src="/images/banner.png" alt="FPT Shop Banner">
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="category-list">
            <div class="category-item">
                <a href="shop/products.php?category=iphone">
                    <img src="/images/iphone.jpg" alt="iPhone">
                    <p>iPhone</p>
                </a>
            </div>
            <div class="category-item">
                <a href="/shop/products.php?category=laptop">
                    <img src="/images/laptop.jpg" alt="Laptop">
                    <p>Laptop</p>
                </a>
            </div>
            <div class="category-item">
                <a href="/shop/products.php?category=apple-watch">
                    <img src="/images/apple-watch.jpg" alt="Apple Watch">
                    <p>Apple Watch</p>
                </a>
            </div>
            <div class="category-item">
                <a href="/shop/products.php?category=samsung">
